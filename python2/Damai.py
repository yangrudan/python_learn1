...
class Concert:
    def __init__(self):
        ...
        path = Service('chromedriver.exe')  # 定义chrome驱动去地址
        self.driver = webdriver.Chrome(executable_path=r'C:\Program Files\Google\Chrome\Application\chrome.exe', service=path)        # 默认Chrome浏览器
